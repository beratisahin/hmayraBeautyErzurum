  ...
  handleChange(e) {
    ...
    this.setState({
      kampanyaAd: encodeURI(
        `https://wa.me/++905013362125?text=${e.target.value}`
      ),
    });
  }
      ...
      >
        <div class="col-lg-4 col-md-6 col-sm-12 col-12">
          <Taslak
            ...
            taslakphoto={m5}
            taslaktext="Erzurum Hmayra Beauty Salononu olarak siz değerli müşterilerimize lazer epilasyon, cilt bakımı ve bölgesel incelme vb alanlarda hizmet vermekteyiz."
